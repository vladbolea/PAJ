...
public class Test1 {
    ...
    public void testBank() throws ClientExistsException {
        ...
        Client client2 = new Client("Smith Michelle", Gender.FEMALE, "Braila");
        ...
        List<Client> clientList = new ArrayList<>(bank.getClients());

        assertEquals(2, bank.getClients().size());
        assertEquals("Mr. Smith John", clientList.get(0).getClientGreeting());
        assertEquals("Mr. Smith John", clientList.get(0).toString());
        assertEquals("Ms. Smith Michelle", clientList.get(1).getClientGreeting());
        assertEquals("Ms. Smith Michelle", clientList.get(1).toString());
    }
